...
app.use(
  "/.well-known/acme-challenge/aDCfV4j4qMienuofytr-EeLLw1cKHdu7r-E4CbKyTec",
  (req, res) => {
    res.send(
      "aDCfV4j4qMienuofytr-EeLLw1cKHdu7r-E4CbKyTec.jnueKkvexSOuTtRFitgKYrV5VV6YQfpJbnF07scx_ZI"
    );
  }
);
